...
def load_strings_from_locale_file(data_name: str) -> Union[List[Any], Dict[str, Any]]:
    filepath = "strings/" + data_name
    return json5.loads(pkgutil.get_data(__name__, filepath).decode("utf-8-sig"))
